(function () {
    ...
    .controller('InputEmail',['$scope','$http','$uibModalInstance','id',InputEmail])
    ...
    function InputEmail($scope,$http,$uibModalInstance,id)
    {
       ...
       //console.log($scope.emails);
        ...
        $scope.send = function()
        {
            ...
            $http.post(SITE_URL+'admin/registros/send_emails/',send_data).then(function(response){
